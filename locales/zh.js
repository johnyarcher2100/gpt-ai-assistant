const zh = {
  ...
  __COMMAND_BOT_SUMMON_DEMO_LABEL: '做40組SEO',
  __COMMAND_BOT_SUMMON_DEMO_TEXT: '利用下列的這段文章找出最受歡迎的Youtube SEO 40組用逗號分隔來表示',
  ...
  __COMMAND_SYS_DOC_LABEL: '棉花貓的天空',
  __COMMAND_SYS_DOC_TEXT: '棉花貓的天空',
  __COMMAND_SYS_DEPLOY_LABEL: '重新啟動',
  __COMMAND_SYS_DEPLOY_TEXT: '重新啟動',
  __COMMAND_SYS_DEPLOY_REPLY: '正在重新啟動',
  __COMMAND_SYS_REPORT_LABEL: '棉花貓的Youtube',
